...
- [ ] T005 [Infra] Author `infra/k8s/base/rbac.yaml` — `ServiceAccount` `testurio-deployer`, `Role` with least-privilege verbs on deployments/services/configmaps/secrets/replicasets, `RoleBinding` — `infra/k8s/base/rbac.yaml`
