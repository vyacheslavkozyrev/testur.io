...
{
    [AllowedValues(null, "en", "uk", "es", "be", ErrorMessage = "Language must be one of: en, uk, es, be.")]
    public string? Language { get; init; }

    [AllowedValues(null, "light", "dark", ErrorMessage = "Theme must be one of: light, dark.")]
